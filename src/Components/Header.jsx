      ...
      <AppBar position="static" sx={{backgroundColor:'black'}}>
        <Toolbar>
          <IconButton
            ...
            sx={{ mr: 2 }}
          >
            <img src="https://r-builder-ecru.vercel.app/assets/logo-pLNiXI3r.png" alt="image" width={60}/>
          </IconButton>
          <Typography variant="h6" component="div" sx={{ flexGrow: 1 ,fontWeight:'bold',fontSize:'23px'}}>
            rBuilder
          </Typography>
